<div id="bill-form-container">
                ...
                <div class="pull-right text-right">
                    <address>
                        ...
                        <p class="text-muted m-l-30">
                            ...
                            <?php if($field->customfields_show_invoice == 'yes'): ?>
                            <br /> <?php echo e(strip_tags(customFieldValue($field->customfields_name, $bill, $field->customfields_datatype))); ?>
    ...
    <?php endif; ?><?php /**PATH /var/www/html/grow-crm-live/application/resources/views/pages/bill/bill-web.blade.php ENDPATH**/ ?>